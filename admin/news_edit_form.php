...
if(isset($_GET['id'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $update_publication = "UPDATE tbl_news SET add_by='$addBy' ,en_title='$en_title', en_body='$en_body', kh_title ='$kh_title', kh_body ='$kh_body', update_date='$update_date' WHERE id = '$id'";
