<?php
            ...
            //check condition for input data
                    ...
                    elseif (!isset($con_pass) || $con_pass == ''){
                        ...
                        $query = "SELECT 1 FROM tbl_user WHERE email='$email' OR username = '$username'";
                        $select_Result= mysqli_query($conn, $query);
                        if(mysqli_num_rows($select_Result)>0) {
                            $email_match = "Email already exit please enter other email";
                        ...
                        $insert = "INSERT INTO tbl_user(username, email, password, user_role ,created_date)
